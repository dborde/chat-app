...
// socketio expects to be called with the raw http server (using node's here)
...
/**
 * load in the client side of the sockio library in index.html
 * <script> src="/socket.io/io.js"</script>
 */
server.listen(port, () => {
